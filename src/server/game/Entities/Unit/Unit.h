...
enum UnitState : uint32
{
    ...
    UNIT_STATE_IGNORE_ANTISPEEDHACK = UNIT_STATE_FLEEING | UNIT_STATE_CONFUSED | UNIT_STATE_CHARGING | UNIT_STATE_JUMPING | UNIT_STATE_DISTRACTED | UNIT_STATE_POSSESSED,
